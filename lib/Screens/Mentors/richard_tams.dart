...
class RichardTams extends StatefulWidget {
  const RichardTams({Key? key}) : super(key: key);

  @override
  State<RichardTams> createState() => _RichardTamsState();
}

class _RichardTamsState extends State<RichardTams> {
  @override
              ...
              child: Column(
                ...
                children: [
                  ...
                  customButton(context,
                      ...
                      onTap: () {
                        nextPage(context, page:  const Lesson());
                      }, text: 'Proceed')
